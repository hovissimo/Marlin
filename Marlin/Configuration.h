...
#define STRING_CONFIG_H_AUTHOR "(hovis, RAMPS for my Printrbot 1403)" // Who made the changes.
...
#define TEMP_SENSOR_1 1 // Don't think I use this --Hovis
...
const bool Z_MIN_ENDSTOP_INVERTING = false; // RevF4 config is true, but experiment says this should be false --hovis
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define BACK_PROBE_BED_POSITION 15
    #define FRONT_PROBE_BED_POSITION 135
  ...
  // sort of kind of measured --hovis
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 2020, 94.5}  // Taken from printrbot.com  (does not match Printrboard RevF4 config) --hovis
#define DEFAULT_MAX_FEEDRATE          {100, 100, 2, 14}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {2000,2000,30,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
// I copied the 2000, 2000, 30, 10000 values from the latest Rev F4 Printrboard configuration --hovis
